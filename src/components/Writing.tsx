        ...
        <ul className="mt-12">
          {site.writings.map((w, i) => (
            <Reveal key={w.title} delay={i * 0.05}>
              <li className="group grid grid-cols-[4rem_1fr] gap-4 border-t border-line/50 py-6 transition-colors first:border-t-0 hover:bg-paper-2/30 md:grid-cols-[6rem_1fr_auto] md:gap-8 md:py-8">
